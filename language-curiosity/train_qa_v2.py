...
def main(args):
    ...
    # set a fixed goal
    goal_text = 'arrange the objects so that their colors range from blue to green in the horizontal direction, and keep the objects close vertically'
    ...
    while True:
        ...
        accg = account / tot
        writer.add_scalar('data/aacg', accg, global_update)
        with open('ppo_seed2.csv','a',newline='') as file:
